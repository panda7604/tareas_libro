...
// este 1.6 nos pide aumnetar la paleta de colores y hacer que se muestren cambiando el tercer argumento del set color index
...
func lissajous(out io.Writer) {
	...
	phase := 0.0
	for i := 0; i < nframes; i++ {
		color := uint8(rand.Intn(len(palette) - 1))
